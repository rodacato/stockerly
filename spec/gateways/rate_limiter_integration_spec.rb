...
RSpec.describe "Gateway RateLimiter integration" do
  describe "PolygonGateway" do
    subject(:gateway) { PolygonGateway.new(api_key: "test_key") }
  ...
  describe "CoingeckoGateway" do
    subject(:gateway) { CoingeckoGateway.new(api_key: "test_key") }
  ...
  describe "AlphaVantageGateway" do
    subject(:gateway) { AlphaVantageGateway.new(api_key: "test_key") }
  ...
  describe "FxRatesGateway" do
    subject(:gateway) { FxRatesGateway.new(api_key: "test_key") }
