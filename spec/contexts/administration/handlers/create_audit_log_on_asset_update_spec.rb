...
RSpec.describe Administration::Handlers::CreateAuditLogOnAssetUpdate do
  ...
  it "skips audit when asset has been deleted between publish and handle" do
    event = Administration::Events::AssetUpdated.new(asset_id: -1, admin_id: admin.id, symbol: "GONE", changes: {})
