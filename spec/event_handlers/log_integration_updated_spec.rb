...
RSpec.describe LogIntegrationUpdated do
  describe ".call" do
    let(:event) { IntegrationUpdated.new(integration_id: 1, provider_name: "Polygon.io", changes: { "daily_call_limit" => { from: 500, to: 1000 } }) }
