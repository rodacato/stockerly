...
RSpec.describe RecalculateTrendScoreOnPriceUpdate do
  describe ".async?" do
    it "is async" do
  ...
  describe ".call" do
    ...
    context "with sufficient price history" do
      ...
      it "creates a TrendScore record" do
        event = AssetPriceUpdated.new(asset_id: asset.id, symbol: asset.symbol, new_price: "120.0", old_price: "119.0")
    ...
    context "with insufficient price history" do
      ...
      it "does not create a TrendScore record" do
        event = AssetPriceUpdated.new(asset_id: asset.id, symbol: asset.symbol, new_price: "105.0", old_price: "104.0")
    ...
    context "when asset is not found" do
      it "does nothing" do
        event = AssetPriceUpdated.new(asset_id: -1, symbol: "FAKE", new_price: "100.0", old_price: "99.0")
