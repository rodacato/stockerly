...
RSpec.describe LogPoolKeyChange do
  describe ".call" do
    it "logs pool key addition with success severity" do
      event = PoolKeyAdded.new(integration_id: 1, pool_key_id: 1, key_name: "Production")
