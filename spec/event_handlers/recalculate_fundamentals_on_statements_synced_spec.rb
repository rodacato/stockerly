...
RSpec.describe RecalculateFundamentalsOnStatementsSynced do
  ...
  it "skips when asset not found" do
    bad_event = FinancialStatementsSynced.new(asset_id: -1, symbol: "FAKE", statement_types: [])
