  ...
  module Domain
    ...
    module ProviderDefaults
      ...
      ALL = {
        ...
        # answers the ticker search, so the ceiling was raised to fit the work.
        "Yahoo Finance"  => { provider_type: "Indices, BMV Corporate Actions & Ticker Search", requires_api_key: false, max_requests_per_minute: 30, daily_call_limit: 2_000 },
