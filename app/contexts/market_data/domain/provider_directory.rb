  ...
  module Domain
    ...
    module ProviderDirectory
      ...
      ENTRIES = {
        ...
        "Alpaca"         => Info.new("Cierre confirmado e histórico de acciones de EE. UU., más sus dividendos y splits. La API key se guarda como ID:SECRETO.", "https://app.alpaca.markets/signup", true,
        ...
        "Alternative.me" => Info.new("Índice Fear & Greed de cripto (sentimiento).", "https://alternative.me/crypto/fear-and-greed-index/", false,
