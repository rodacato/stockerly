module Admin
  class PoolKeysController < BaseController
    def create
      result = Administration::UseCases::Integrations::AddPoolKey.call(
        admin: current_user,
    ...
    def toggle
      result = Administration::UseCases::Integrations::TogglePoolKey.call(
        admin: current_user,
    ...
    def destroy
      result = Administration::UseCases::Integrations::RemovePoolKey.call(
        admin: current_user,
        params: { id: params[:id].to_i }
      )
