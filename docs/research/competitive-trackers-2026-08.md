...
The MXN/USD + Banxico-FX-at-execution angle stays the differentiator — a generic tracker's single-currency CSV glosses over trade-time FX, and fixing that P0 doubles as a data-entry improvement.
...
| 3 | Manual made pleasant (autocomplete, **Banxico FX auto-filled at trade**, learned rules) | Low–Med | Med–High | **Table stakes** — also fixes the P0 currency bug |
