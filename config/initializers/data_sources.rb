...
Rails.application.config.after_initialize do
  DataSourceRegistry.register(:polygon_stocks,
    ...
    icon: "show_chart",
    color: "indigo",
    gateway_class: MarketData::PolygonGateway,
  ...
  DataSourceRegistry.register(:coingecko_crypto,
    ...
    color: "emerald",
    gateway_class: MarketData::CoingeckoGateway,
    job_class: SyncPriorityAssetsJob,
  ...
  DataSourceRegistry.register(:yahoo_bmv,
    ...
    icon: "language",
    color: "sky",
    gateway_class: MarketData::YahooFinanceGateway,
    job_class: SyncPriorityAssetsJob,
    job_args: %w[stock high],
  ...
  DataSourceRegistry.register(:crypto_fear_greed,
    ...
    icon: "psychology",
    color: "purple",
    gateway_class: MarketData::CryptoFearGreedGateway,
  ...
  DataSourceRegistry.register(:stock_fear_greed,
    ...
    icon: "psychology",
    color: "rose",
    gateway_class: MarketData::StockFearGreedGateway,
    job_class: RefreshFearGreedJob,
    job_args: [],
    test_symbol: nil,
  ...
  DataSourceRegistry.register(:alpha_vantage_fundamentals,
    ...
    icon: "analytics",
    color: "orange",
    gateway_class: MarketData::AlphaVantageGateway,
  ...
  DataSourceRegistry.register(:fx_rates,
    ...
    color: "amber",
    gateway_class: MarketData::FxRatesGateway,
  ...
  DataSourceRegistry.register(:banxico_cetes,
    ...
    color: "lime",
    gateway_class: MarketData::BanxicoGateway,
