namespace :stockerly do
  ...
  task seed_assets: :environment do
    assets = [
      # US Tech (NASDAQ)
      { symbol: "AAPL",  name: "Apple Inc.",        asset_type: :stock, sector: "Technology",       exchange: "NASDAQ", country: "US", data_source: nil },
      { symbol: "MSFT",  name: "Microsoft Corp.",   asset_type: :stock, sector: "Technology",       exchange: "NASDAQ", country: "US", data_source: nil },
      { symbol: "NVDA",  name: "NVIDIA Corp.",      asset_type: :stock, sector: "Technology",       exchange: "NASDAQ", country: "US", data_source: nil },
      { symbol: "GOOGL", name: "Alphabet Inc.",     asset_type: :stock, sector: "Technology",       exchange: "NASDAQ", country: "US", data_source: nil },
      { symbol: "META",  name: "Meta Platforms",    asset_type: :stock, sector: "Technology",       exchange: "NASDAQ", country: "US", data_source: nil },
      { symbol: "AMZN",  name: "Amazon.com Inc.",   asset_type: :stock, sector: "Consumer Cyclical", exchange: "NASDAQ", country: "US", data_source: nil },
      # US Other (NYSE / NASDAQ)
      { symbol: "TSLA",  name: "Tesla, Inc.",       asset_type: :stock, sector: "Consumer Cyclical", exchange: "NASDAQ", country: "US", data_source: nil },
      { symbol: "JPM",   name: "JPMorgan Chase",   asset_type: :stock, sector: "Finance",          exchange: "NYSE",   country: "US", data_source: nil },
      { symbol: "JNJ",   name: "Johnson & Johnson", asset_type: :stock, sector: "Healthcare",       exchange: "NYSE",   country: "US", data_source: nil },
      { symbol: "OKE",   name: "Oneok Inc.",        asset_type: :stock, sector: "Energy",           exchange: "NYSE",   country: "US", data_source: nil },
      { symbol: "KO",    name: "Coca-Cola Co.",     asset_type: :stock, sector: "Consumer",         exchange: "NYSE",   country: "US", data_source: nil },
      { symbol: "PG",    name: "Procter & Gamble",  asset_type: :stock, sector: "Consumer",         exchange: "NYSE",   country: "US", data_source: nil },
      { symbol: "AVGO",  name: "Broadcom Inc.",     asset_type: :stock, sector: "Technology",       exchange: "NASDAQ", country: "US", data_source: nil },
      { symbol: "AMD",   name: "Advanced Micro Devices", asset_type: :stock, sector: "Technology",  exchange: "NASDAQ", country: "US", data_source: nil },
      { symbol: "INTC",  name: "Intel Corp.",       asset_type: :stock, sector: "Technology",       exchange: "NASDAQ", country: "US", data_source: nil },
      { symbol: "NFLX",  name: "Netflix, Inc.",     asset_type: :stock, sector: "Consumer Cyclical", exchange: "NASDAQ", country: "US", data_source: nil },
      { symbol: "COIN",  name: "Coinbase Global",   asset_type: :stock, sector: "Finance",          exchange: "NASDAQ", country: "US", data_source: nil },
      # US ETFs
